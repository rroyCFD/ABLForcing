...
template<class Type>
void Foam::drivingForceMod<Type>::updateGivenTimeDepSource_(bool writeIter)
{
...
template<class Type>
void Foam::drivingForceMod<Type>::updateGivenTimeHeightDepSource_(bool writeIter)
{
...
template<class Type>
void Foam::drivingForceMod<Type>::updateComputedTimeDepSource_(bool writeIter)
{
...
template<class Type>
void Foam::drivingForceMod<Type>::updateComputedTimeHeightDepSource_(bool writeIter)
{
    // Interpolate specified source values in time and height
...
template<class Type>
void Foam::drivingForceMod<Type>::writeSourceHistory_
(
    Type& source
)
{
...
template<class Type>
void Foam::drivingForceMod<Type>::writeErrorHistory_
(
    Type& error
)
{
...
template<class Type>
Type Foam::drivingForceMod<Type>::speedDirToComp_
(
    Type desiredField
)
{
...
template<class Type>
Type Foam::drivingForceMod<Type>::subtractVerticalPart_
(
    Type source
)
{
...
{
    template<>
    vector Foam::drivingForceMod<vector>::speedDirToComp_
    (
        vector desiredField
    )
    {
    ...
    template<>
    vector Foam::drivingForceMod<vector>::subtractVerticalPart_
    (
        vector source
    )
    {
...
template<class Type>
void Foam::drivingForceMod<Type>::readInputData_(const IOdictionary& ABLProperties)
{
...
template<class Type>
void Foam::drivingForceMod<Type>::readSourceTables_
(
...
{
    template<>
    void drivingForceMod<scalar>::readSourceTables_
    (
        const dictionary& sourceDict,
        label& nSourceHeights
    )
...
template<class Type>
void Foam::drivingForceMod<Type>::checkSourceTableSize_
(
...
template<class Type>
void Foam::drivingForceMod<Type>::findSingleForcingHeight_()
{
...
template<class Type>
void Foam::drivingForceMod<Type>::openFiles_()
{
...
template<class Type>
Foam::drivingForceMod<Type>::drivingForceMod
(
...
template<class Type>
void Foam::drivingForceMod<Type>::update(bool writeIter)
{
