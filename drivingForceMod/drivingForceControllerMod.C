...
template<class Type>
void Foam::drivingForceMod<Type>::initializeController_()
{
...
template<class Type>
List<Type> Foam::drivingForceMod<Type>::updateController_
(
    List<Type>& error
)
{
...
template<class Type>
scalarRectangularMatrix Foam::drivingForceMod<Type>::computeRegressionCoeff_
(
    List<Type>& y
)
{
...
template<class Type>
List<Type> Foam::drivingForceMod<Type>::constructRegressionCurve_
(
...
{
    template<>
    scalarRectangularMatrix drivingForceMod<scalar>::computeRegressionCoeff_
    (
        List<scalar>& y
    )
    {
    ...
    template<>
    List<scalar> drivingForceMod<scalar>::constructRegressionCurve_
    (
        scalarRectangularMatrix& beta
    )
    {
